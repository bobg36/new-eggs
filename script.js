            ...
            <div class="image-container">
                <div>
                    <a href="https://app.axieinfinity.com/marketplace/axies/${egg.sireId}" target="_blank" rel="noopener noreferrer">
                        <img src="https://assets.axieinfinity.com/axies/${egg.sireId}/axie/axie-full-transparent.png" alt="Sire">
                        <p>${egg.sireId}</p>
                    </a>
                </div>
                <div>
                    <a href="https://app.axieinfinity.com/marketplace/axies/${egg.matronId}" target="_blank" rel="noopener noreferrer">
                        <img src="https://assets.axieinfinity.com/axies/${egg.matronId}/axie/axie-full-transparent.png" alt="Matron">
                        <p>${egg.matronId}</p>
                    </a>
                </div>
            </div>
